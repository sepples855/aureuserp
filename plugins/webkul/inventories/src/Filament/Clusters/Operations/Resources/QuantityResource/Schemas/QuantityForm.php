...
namespace Webkul\Inventory\Filament\Clusters\Operations\Resources\QuantityResource\Schemas;
            ...
            ->components([
                ...
                Select::make('lot_id')
                    ...
                    ->visible(function (Get $get): bool {
                        if (! QuantityResource::getTraceabilitySettings()->enable_lots_serial_numbers) {
                            return false;
                        }
                ...
                DatePicker::make('scheduled_at')
                    ...
                    ->native(false)
                    ->default(now()->setDay(QuantityResource::getOperationSettings()->annual_inventory_day)->setMonth(QuantityResource::getOperationSettings()->annual_inventory_month)),
            ])
            ->columns(1);
    }
}
